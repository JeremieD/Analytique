...
class JDCalendar extends HTMLElement {
	...
	connectedCallback() {
		...
		const icon1 = document.createElement("jd-icon");
		icon1.setAttribute("icon", "chevron-left");
		this.previousMonthButton.append(icon1);
		...
		const icon2 = document.createElement("jd-icon");
		icon2.setAttribute("icon", "chevron-right");
		this.nextMonthButton.append(icon2);
